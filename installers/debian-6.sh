...
#
# install-debian-6.sh
#           installation script for phix on Debian Squeeze
#
...
apt-get install -y gcc make php5-dev php-pear php5-xdebug php5-imagick php5-xsl libncursesw5-dev || die "apt-get install failed; please investigate why"
